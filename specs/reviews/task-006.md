...
- [-] **F1 — [process-revision-complete] Trust anchor endpoints lack tenant isolation (cross-tenant authorization bypass)**
...
- [-] **F2 — [process-revision-complete] Key binding endpoint does not verify `user_signature` against `public_key`**
