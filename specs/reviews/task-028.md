...
- [ ] **F9: Atomic group deferral path has zero test coverage — readiness check can be deleted without test failure.**  
...
- [ ] **F10: MCP `handle_create_mr` does not detect or merge branch lineage dependencies — REST-MCP parity gap.**  
