...
- [ ] **F1: Existing-MR detection omits required author check (spec violation)**
...
- [ ] **F2: MR `author_agent_id` not set on creation**
...
- [ ] **F3: Stale "(stubbed)" in module doc comment**
...
- [ ] **F4: Tests do not verify notification creation (compound acceptance criterion partially satisfied)**
