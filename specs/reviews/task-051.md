...
- [-] [process-revision-complete] **F5: DetailPanel `repoCount` counts "unknown" group as a repo — inconsistent with SpecDashboard.**  
...
- [-] [process-revision-complete] **F6: DetailPanel test lacks transitive dependents — R2 "depth N" branch untested.**  
