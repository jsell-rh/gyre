...
- [ ] **F1: Cross-workspace filter direction is inverted relative to spec and link convention.**
...
- [ ] **F2: Missing `actions` field on exception items — spec violation.**
...
- [ ] **F3: Gate results not filtered by gate result timestamp — old failures leak into briefing.**
