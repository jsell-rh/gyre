...
|---|---------|-------|--------|------|-------|
| 1 | The Model | 2 | task-assigned | task-115 | |
| 2 | 1. Agent Lifecycle | 2 | task-assigned | task-115 | |
| 3 | The Signal Chain | 3 | task-assigned | task-115 | |
| 4 | Phase 1: Spec Approval Triggers Orchestration | 3 | task-assigned | task-115 | |
| 5 | Phase 2: Workspace Orchestrator — Cross-Repo Coordination | 3 | task-assigned | task-115 | |
| 6 | Phase 3: Repo Orchestrator — Task Decomposition | 3 | task-assigned | task-115 | |
| 7 | Phase 4: System Spawns Agents (Mechanical) | 3 | task-assigned | task-118 | |
| 8 | Phase 5: Implementation | 3 | task-assigned | task-118 | |
| 9 | Phase 6: MR and Gates | 3 | task-assigned | task-118 | |
| 10 | Phase 7: Ralph Loop | 3 | task-assigned | task-118 | |
| 11 | Phase 8: System-Initiated Agents | 3 | task-assigned | task-118 | |
