...
| 12 | Saved Views | 2 | not-started | - | Next cycle |
| 13 | DB Schema | 3 | not-started | - | Next cycle |
| 14 | System Default Views | 3 | not-started | - | Next cycle |
| 15 | REST API | 3 | not-started | - | Next cycle |
...
| 24 | Migration Plan | 2 | not-started | - | Next cycle |
| 25 | Phase 1: Canvas + Filters | 3 | task-assigned | task-065 | |
| 26 | Phase 2: Chat + Agent | 3 | task-assigned | task-071 | |
| 27 | Phase 3: Saved Views | 3 | not-started | - | Next cycle |
| 28 | Phase 4: Polish | 3 | not-started | - | Next cycle |
| 29 | Testing | 2 | not-started | - | Next cycle |
| 30 | Unit Tests | 3 | not-started | - | Next cycle |
| 31 | Integration Tests | 3 | not-started | - | Next cycle |
| 32 | Visual Tests | 3 | not-started | - | Next cycle |
| 33 | Relationship to Other Specs | 2 | not-started | - | Next cycle |
