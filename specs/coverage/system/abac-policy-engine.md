...
| 2 | Core Concepts | 2 | task-assigned | task-128 | |
| 3 | Attributes | 3 | task-assigned | task-128 | |
| 4 | Policy Language | 2 | task-assigned | task-128 | |
| 5 | Policy Entity | 3 | task-assigned | task-128 | |
| 6 | Conditions | 3 | task-assigned | task-128 | |
| 7 | Policy Examples | 3 | task-assigned | task-128 | |
