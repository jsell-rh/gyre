...
pub trait NotificationRepository: Send + Sync {
    ...
    async fn has_recent_dismissal(&self, workspace_id: &Id, notification_type: &str, days: u32) -> Result<bool>;
    // Used by trust_suggestion_check job: returns true if any user dismissed this type within N days
}
```
