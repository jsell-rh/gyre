...
**Q&A endpoint:** `POST /api/v1/workspaces/:workspace_id/briefing/ask` — request: `{question: "..."}`, response: `{answer: "...", sources: [{spec_path, agent_id, ...}]}`. ABAC: `RouteResourceMapping` with `resource_type: "workspace"`, `workspace_param: "workspace_id"`, `action_override: "generate"`. Requires workspace membership.
