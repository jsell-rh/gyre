...
Reconciliation is the process of re-implementing code under updated meta-specs. It re-runs the Ralph loop with the same specs but new rules, on branches, without touching main.
