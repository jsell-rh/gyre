---
title: "MCP Message Bus Tools (message.send, message.poll, message.ack)"
spec_ref: "message-bus.md §MCP Integration"
depends_on: []
progress: complete
...
- `fix(mcp): address TASK-001 review findings F7-F8 — broadcast parity, full message serialization`
