...
**Depends on:** TASK-029 (lens toggle, complete), TASK-030 (structural coloring, complete), TASK-031 (drill-down, complete), TASK-032 (causal flow trace, complete), TASK-033 (evaluative heat map, complete), TASK-037 (view query types, complete)  
