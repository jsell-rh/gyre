...
6. **API endpoint registration:** If you added an HTTP handler, it is registered in the router (in `gyre-server`), has auth middleware, and is documented in `docs/api-reference.md`.
