...
| `GET` | `/api/v1/repos/{id}/graph/timeline` | Architectural deltas — `[{id, repo_id, commit_sha, timestamp, spec_ref?, agent_id?, delta_json}]`; filter with `?since=<epoch>&until=<epoch>` (M30) |
